...
import { IDusaPair } from './IDusaPair';
import {
  AddLiquidity,
  Amounts,
  GetSwapInReturn,
  GetSwapOutReturn,
} from '../structs/dusa/Returns';
...
export class IDusaRouter {
   ...
   *
   * @param {IMRC20} tokenX - The address of the first token
   * @param {IMRC20} tokenY - The address of the second token
