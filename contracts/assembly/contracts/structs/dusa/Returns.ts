...
export class Amounts {
  constructor(public amountX: u256, public amountY: u256) {}
}
...
export class AddLiquidity {
  constructor(public liquidityMinted: u256[], public depositIds: u64[]) {}
}
...
export class GetGlobalFeesReturn {
  constructor(public feesX: FeesDistribution, public feesY: FeesDistribution) {}
}
...
export class GetMulProds {
  constructor(public prod0: u256, public prod1: u256) {}
}
...
export class GetIdsFromAboveReturn {
  constructor(public branchId: u32, public leafId: u32) {}
}
