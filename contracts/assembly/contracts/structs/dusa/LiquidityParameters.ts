...
export class LiquidityParameters implements Serializable {
  /**
   * @param {IMRC20} tokenX - The address of token X
   * @param {IMRC20} tokenY - The address of token Y
   ...
   */
  constructor(
    public tokenX: IMRC20 = new IMRC20(new Address('')),
    public tokenY: IMRC20 = new IMRC20(new Address('')),
